...
public class ControllerPlayers implements Initializable {
        ...
        if(!isSelectedSquare(squarePosition) && this.allowMoves == true){//activate one of the X-s by the position of the square
            switch(squarePosition) {
                ...
                default:
                    ...
                    break;}
            this.filledSquares[this.filledSquaresCounter] = squarePosition;//fill filled squares array with this position
            this.filledX[this.filledXCounter] = squarePosition;//fill filled X-s array with this position
            this.filledSquaresCounter++;//increase the counter of the squares
    ...
    public void endGame() { //print necessary output results
        ...
        if(this.tie == true) {
            ...
            this.resultTextLabel.setText("The winner is O!");
        } else if(String.valueOf(this.winningTeam).equals("X")) {
            this.resultTextLabel.setText("The winner is X!");}}
    ...
    public boolean checkVictory() { //check all of the winning position
        ...
        if((isOccupiedByCircle(1) && isOccupiedByCircle(2) && isOccupiedByCircle(3)) ||
                ...
                (isOccupiedByCircle(7) && isOccupiedByCircle(8) && isOccupiedByCircle(9)) ||
                (isOccupiedByCircle(1) && isOccupiedByCircle(4) && isOccupiedByCircle(7)) ||
                (isOccupiedByCircle(2) && isOccupiedByCircle(5) && isOccupiedByCircle(8)) ||
        ...
        if((isOccupiedByX(1) && isOccupiedByX(2) && isOccupiedByX(3)) ||
                (isOccupiedByX(4) && isOccupiedByX(5) && isOccupiedByX(6)) ||
                (isOccupiedByX(7) && isOccupiedByX(8) && isOccupiedByX(9)) ||
                (isOccupiedByX(1) && isOccupiedByX(4) && isOccupiedByX(7)) ||
                (isOccupiedByX(2) && isOccupiedByX(5) && isOccupiedByX(8)) ||
